...
I am currently a Ph.D. student in [Mechatronics, Systems and Control Lab (MSC Lab)](https://msc.kaist.ac.kr/) at [KAIST](https://www.kaist.ac.kr/en/), advised by Prof. [Kyung-Soo Kim](https://scholar.google.com/citations?user=PQLo0oEAAAAJ&hl=ko).
...
<p style="font-size:0.9em;color:#6b6b6b;margin-top:0.15rem;margin-bottom:0.2rem;"><span style="background-color: rgba(250, 255, 110, 0.467); padding: 2px 5px; border-radius: 4px; color: #6b6b6b;">yellow</span>: representative publications. <sup>*</sup>: equal contribution. <sup>&dagger;</sup>: equal advising.</p>
